...
import ThreeBodyCover from '@/app/components/three-body/ThreeBodyCover'
...
const library: BookProject[] = [
    // Mock ThreeBody for now as it seems to be refactored differently in the original file
    {
        meta: {
            id: 'three-body',
            title: 'THREE-BODY PROBLEM',
            author: 'Cixin Liu',
            coverStyle: { color: '#F00', texture: 'cyber' },
            summary: 'A secret military project sends signals into space.',
            readingTime: '20h',
            tags: ['SCI-FI', 'PHILOSOPHY'],
            publishDate: '2008'
        },
        Cover: ThreeBodyCover as any,
        Experience: () => null
    },
    sapiens,
    shadowsOfTheSun
