...
export default function Content() {
    // UPDATED NAMESPACE: three-body.vol1.content
    ...
    return (
        <article className="max-w-4xl mx-auto px-6 py-24 md:py-32 font-serif text-white leading-loose">
            ...
            {/* Character Archive */}
            <CharacterMap />
            {/* ... Rest is structurally same, just using new t namespace implicitly via provider ... */}
